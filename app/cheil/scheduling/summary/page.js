            ...
            <div className="flex items-center flex-row">
              ...
              <div className="flex flex-row w-[100%]">
                <div className="flex items-center gap-2 text-sm w-[30%] pl-2 ">
                  <span className="font-bold">Last Run-time</span>
                </div>
                <div className="flex items-center gap-2 text-sm w-[30%] ">
                  <span className="font-bold">Subsidiaries</span>
                </div>
                <div className="flex items-center gap-2 text-sm w-[30%]">
                  <span className="font-bold">Schedulers</span>
                </div>
                <div className="flex items-center gap-2 text-sm w-[30%] ">
                  <span className="font-bold">Result</span>
                </div>
                <div className="flex items-center gap-2 text-sm w-[30%]">
                  <span className="font-bold">Issued cases</span>
                </div>
