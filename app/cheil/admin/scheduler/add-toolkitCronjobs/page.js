...
const AddToolkitCronjobs = () => {
  ...
  const { campaign, skus } = formValues;
  ...
  const handleSaveClick = async () => {
    ...
    try {
      ...
      router.push("/cheil/admin/scheduler");
    } catch (err) {
                ...
                <div className="flex flex-col gap-2 w-full">
                  ...
                  <div className="flex flex-row gap-7 items-center">
                    <textarea
                      ...
                      className="h-32 border-solid border-2 border-gray-300 rounded-md w-full"
                    />
                  </div>
                </div>
              </div>
  ...
  />
  {campaignError && (
    <div className="text-red-500 w-full  text-start text-sm mt-1">Campaign identifier is mandatory.</div>
  )}
</div>

            </div>
            <div className="p-2">
              <Models  initialload={initialload} Model={Model} setModel={setModel} />
            </div>
          </div>
