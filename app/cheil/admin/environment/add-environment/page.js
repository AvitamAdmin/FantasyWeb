        ...
        {params.map((param, index) => (
          ...
          >
           ...
           <button
                ...
                className={`${
                  param.beforeUrl ? "bg-[#1581ed] text-white" : "bg-[#fff] text-gray-700"
              ...
              <button
                ...
                className={`${
                  param.afterUrl ? "bg-[#1581ed] text-white" : "bg-[#fff] text-gray-700"
           ...
           <button
                ...
                className={`${
                  param.beforeClick ? "bg-[#1581ed] text-white" : "bg-[#fff] text-gray-700"
              ...
              <button
                ...
                className={`${
                  param.afterClick ? "bg-[#1581ed] text-white" : "bg-[#fff] text-gray-700"
