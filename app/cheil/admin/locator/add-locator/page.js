...
const toggleSection = (section) => {
      ...
      <div className="flex flex-col w-full">
        ...
        />
              ...
              <div className=" w-full flex flex-row justify-between gap-10 p-2 items-center">
               <MethodsDropdown       initialload={initialload}
 methods={methods} setMethods={setMethods}/>
            ...
            <TestDataTypesDropDown       initialload={initialload}
 setSelectedTestDataTypes={setTestDataTypes} selectedTestDataTypes={testDataTypes}/>

             <TestDataSubTypeDropDown       initialload={initialload}
 testDataSubtypes={testDataSubtypes} setTestDataSubtypes={setTestDataSubtypes}/>
    ...
    <div className="p-3">
      <div className="bg-white w-full h-72 rounded-md shadow-md flex flex-col justify-start gap-2 pb-4">
        {sitesList.map((item, index) => (
          <div
            key={index}
            className="w-full flex flex-row justify-between gap-5 p-2 items-center"
          >
            <div className="w-[10%] text-md">{item.identifier}</div>
            ...
            <TextField
              ...
              onChange={(e) =>
                handleFieldInputChange(index, "inputData", e.target.value)
              }
            />
          </div>
        ))}
