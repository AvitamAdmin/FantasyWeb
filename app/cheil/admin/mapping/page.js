...
if (deleteStatus === "deleted") {
  ...
  const fetchMappings = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${api}/admin/mapping`, body, { headers });

      setMappings(response.data.sourceTargetMappings || []);
      console.log(response.data.sourceTargetMappings,"response.data.sourceTargetMappings");
...
const deleteKeyField = "sourceTargetMappings";
  ...
  const fetchexportUrl = async () => {
    try {
      ...
      const response = await axios.get(`${api}/admin/mapping/export`, {
        headers,
      });
