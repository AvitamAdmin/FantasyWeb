...
import { setSelectedRoleId } from "@/app/src/Redux/Slice/slice";
...
const Addrole = () => {
  ...
  const handleSaveClick = async () => {
    ...
    try {
      ...
      const body = {
        roles: [
          {
            name: formValues.username,  // Use formValues.username
  ...
  <div className="flex flex-col w-[45%]" key={parentId}>
    {parentNode.childNodes && Array.isArray(parentNode.childNodes) ? (
      <MultiSelect
