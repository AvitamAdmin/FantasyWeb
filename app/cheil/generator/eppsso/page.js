    ...
    <div className="flex flex-col w-full p-4 gap-5" style={{ fontFamily: "SamsungOne, sans-serif" }}>
      <div className="bg-gray-200 flex flex-col pb-5 rounded-md gap-3 min-h-screen ">
        <div className="flx flex-col ">
          ...
          <button
            className="flex items-center justify-center ml-4 p-2 rounded-md bg-black text-white w-[80px] h-[30px]"
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center">
          <div className="bg-white rounded-md p-6 w-96">
            ...
            <div className="flex justify-end">
              ...
              <button className="bg-gray-300 p-2 rounded-md mr-2" onClick={handleCloseModal}>
                Cancel
              </button>

              <button className="bg-gray-300 p-2 rounded-md mr-2" onClick={handleSubmit}>
                Submit
              </button>
            </div>
          </div>
