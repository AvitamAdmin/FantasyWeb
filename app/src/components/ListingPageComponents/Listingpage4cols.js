      ...
      <IconButton>
        <MdDelete className="text-white bg-[#CC0001] p-1.5 rounded-md text-3xl" />
          ...
          <div
            ...
            className="flex flex-row text-center cursor-pointer p-2 items-center rounded-md bg-[#CC0001] gap-1"
          >
          ...
          <div
            ...
            className="flex flex-row text-center cursor-pointer p-2 items-center rounded-md bg-[#2b2b2b] gap-1"
          >
