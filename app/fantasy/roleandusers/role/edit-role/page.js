...
const Editrole = () => {
  ...
  setTimeout(() => {
        ...
        router.push("/fantasy/roleandusers/role");
      }, 2000);
            ...
            <div className="flex flex-row gap-4 mb-4 items-center justify-center">
              ...
              <div className="flex flex-row gap-4">
                <div
                  ...
                  className={`${
                    isActive ? "bg-[#1581ed] text-center cursor-pointer " : "bg-[#fff] text-center cursor-pointer"
                ...
                <div
                  ...
                  className={`${
                    isPublished ? "bg-[#1581ed] text-center cursor-pointer " : "bg-[#fff] text-center cursor-pointer"
                  } border-2 border-solid border-gray-400 text-center cursor-pointer rounded-md text-gray-500 text-xs px-2 py-0.5 w-[80px] animate__animated animate__pulse`}
                >
  ...
  onChange={(e) => handlePermissionChange(parentId, e.value)}
