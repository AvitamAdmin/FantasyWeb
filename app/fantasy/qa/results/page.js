...
import { MdDelete, MdFileUpload, MdOutlineKeyboardArrowLeft, MdOutlineKeyboardArrowRight, MdOutlineKeyboardDoubleArrowLeft, MdOutlineKeyboardDoubleArrowRight } from 'react-icons/md'
...
console.log(jwtToken,"jwtToken token");
        ...
        <div className="p-1 rounded-md flex flex-row justify-between text-center w-[100%]">
         ...
         <div className="flex-row flex gap-1  w-[10%]">
          ...
          <div onClick={handlemultipledelete}>
            ...
            <div onClick={handleExport} className="flex flex-row p-2 border-solid border-2 border-gray-400 text-center cursor-pointer items-center rounded-md bg-white gap-1">
              <span className="text-gray-500"><MdFileUpload /></span><span className="text-gray-500 text-xs">Export</span>
            </div>
            <div className="flex flex-row gap-4">
              <div className="flex gap-4 items-center justify-end">
                
                <div onClick={handleOpen} className=" border-solid p-2 rounded-md text-xs w-[70px] text-white bg-[#2b2b2b] items-center text-center">
                  Shortcuts
                </div>
                <Link  href="" className=" border-solid p-2 rounded-md text-xs w-[70px] text-white bg-[#cc0001] items-center text-center">
                  Email
                </Link>
              </div>
            </div>
  ...
  {qaResults.length < 1 ? (
    ...
    qaResults.map((item, index) => (
      ...
      <div
        style={{ backgroundColor: "#D3D3D3" }}
        className=" p-2  w-full mt-5 flex justify-between items-center px-2"
      >
