...
import { FaPlus, FaUser, FaStopCircle, FaPlayCircle } from 'react-icons/fa'; // Added Play Circle icon
import { IoIosArrowDown } from 'react-icons/io';
import { IoClose, IoExitOutline, IoSearch } from 'react-icons/io5';
import { MdFileUpload, MdOutlineKeyboardArrowLeft, MdOutlineKeyboardArrowRight, MdOutlineKeyboardDoubleArrowLeft, MdOutlineKeyboardDoubleArrowRight } from 'react-icons/md';
      ...
      <div className="bg-gray-200 p-2 mt-4 rounded-md">
        <div className="p-1 rounded-md flex flex-row justify-between items-center w-full">
          <div className="flex flex-row gap-1">
            ...
            <span className="text-xs font-bold">addOnReport</span>
          </div>
        </div>
            ...
            <div className="flex items-center flex-row">
              ...
              <div className="flex flex-row w-[100%] justify-between">
                <div className="flex items-center gap-2 text-sm w-[30%]">
                  <span className="font-bold pl-2">Main SKU's</span>
                </div>
                ...
                <div className="flex items-center gap-2 text-sm w-[30%]">
                  <span className="font-bold">Accessories Flag</span>
                </div>
                <div className="flex items-center gap-2 text-sm w-[30%]">
                  <span className="font-bold">AddOn SKUs</span>
                </div>
                <div className="flex items-center gap-2 text-sm w-[30%]">
                  <span className="font-bold">Price of AddOn SKUs</span>
                </div>
                <div className="flex items-center gap-2 text-sm w-[30%]">
                  <span className="font-bold">Stock level of AddOn SKUs</span>
                </div>
                <div className="flex items-center gap-2 text-sm w-[30%]">
                  <span className="font-bold">Category of AddOn SKUs</span>
                </div>
              ...
              <div className="flex flex-row w-[100%] justify-between">
                ...
                <div className="w-[30%] flex flex-col items-start justify-center">
                  <input
                    ...
                    name="text"
                    class=" bg-white text-sm border-none shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-gray-500 focus:ring-gray-500 block w-fullrounded-md sm:text-sm focus:ring-1"
                    placeholder="Search Accessories Flag"
                  />
                </div>
                <div className="w-[30%] flex flex-col items-start justify-center">
                  <input
                ...
                <div className="w-[30%] flex flex-col items-start justify-center">
                  <input
                    ...
                    name="text"
                    class=" bg-white text-sm border-none shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-gray-500 focus:ring-gray-500 block w-fullrounded-md sm:text-sm focus:ring-1"
                    placeholder="Search Price of AddOn SKUs"
                  />
                </div>
                <div className="w-[30%] flex flex-col items-start justify-center">
                  <input
                    ...
                    name="text"
                    class=" bg-white text-sm border-none shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-gray-500 focus:ring-gray-500 block w-fullrounded-md sm:text-sm focus:ring-1"
                    placeholder="Search Stock level of AddOn SKUs"
                  />
                </div>
                <div className="w-[30%] flex flex-col items-start justify-center">
                  <input
                    ...
                    name="text"
                    class=" bg-white text-sm border-none shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-gray-500 focus:ring-gray-500 block w-fullrounded-md sm:text-sm focus:ring-1"
                    placeholder="Search Category of AddOn SKUs"
                  />
                </div>
                <div className="flex items-center gap-2 text-sm ">
                  {showInputs ? (
            ...
            <div className="flex flex-col gap-1">
              ...
              {Extend && (
                <div className="flex flex-col gap-1">
                  ...
                  <div>
                    <span className=" text-sm">hybris.sup@Impact11.com</span>
                  </div>
                </div>
              )}
            </div>
