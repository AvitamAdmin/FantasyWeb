...
function DeEppVsEstoreSellingPriceReport() {
      ...
      <div className="bg-gray-200 p-2 mt-4 rounded-md">
        <div className="p-1 rounded-md flex flex-row justify-between items-center w-full">
          <div className="flex flex-row gap-1">
            ...
            <span className="text-xs font-bold">deEppVsEstoreSellingPriceReport</span>
          </div>
        </div>
          ...
          <div className="mt-2 bg-white p-2 rounded-md shadow">
            <div className="flex items-center flex-row">
              ...
              <div className="flex flex-row w-[100%] justify-between">
                ...
                <div className="flex items-center gap-2 text-sm w-[30%]">
                  <span className="font-bold">RRP</span>
                </div>
                <div className="flex items-center gap-2 text-sm w-[30%]">
                  <span className="font-bold truncate">Sales Price CBE{'('}EPP{')'}</span>
                </div>
                <div className="flex items-center gap-2 text-sm w-[30%]">
                  <span className="font-bold">Sales Price Public</span>
                </div>
                <div className="flex items-center gap-2 text-sm w-[30%]">
                  <span className="font-bold">Double Check</span>
                </div>
              ...
              <div className="flex flex-row w-[100%] justify-between">
                ...
                <div className="w-[25%] flex flex-col items-start justify-center">
                  <input
                    ...
                    name="text"
                    class=" bg-white text-sm border-none shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-gray-500 focus:ring-gray-500 block w-fullrounded-md sm:text-sm focus:ring-1"
                    placeholder="Search Sales Price CBE(EPP)"
                  />
                </div>
                <div className="w-[25%] flex flex-col items-start justify-center">
                  <input
                    ...
                    name="text"
                    class=" bg-white text-sm border-none shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-gray-500 focus:ring-gray-500 block w-fullrounded-md sm:text-sm focus:ring-1"
                    placeholder="Search Sales Price Public"
                  />
                </div>
                <div className="w-[25%] flex flex-col items-start justify-center">
                  <input
                    ...
                    name="text"
                    class=" bg-white text-sm border-none shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-gray-500 focus:ring-gray-500 block w-fullrounded-md sm:text-sm focus:ring-1"
                    placeholder="Search Double Check"
                  />
                </div>
                <div className="flex items-center gap-2 text-sm ">
                  {showInputs ? (
...
export default DeEppVsEstoreSellingPriceReport;
