...
const validateForm = () => {
  ...
  const handlePostClick = async () => {
    ...
    try {
     ...
     setTimeout(() => {
      router.push("/fantasy/admin/impactConfig");
              ...
              <div className="p-2">
                <div className="flex flex-col bg-gray-200 p-2 gap-3 rounded-md">
                  {editInputfields.map((item, index) => (
                    <div   key={item.recordId} className="bg-white p-2 rounded-md">
                      <div
                ...
                />
                  ...
                  <div className="flex flex-col mt-4 w-[100%]">
                    ...
                    {item.params &&
                                  item.params.map((param, paramIndex) => (
                                    <div key={paramIndex} className="items-center gap-5 flex flex-row w-[100%] p-2">
                  ...
                  <Autocomplete
                    ...
                    onChange={(event, newValue) => {
                      handleParamChange(index, paramIndex, "labels", newValue || []);
                    }}
                  ...
                  />
                                      ...
                                      type="number"
                                        ...
                                        size="small"
                                        value={param.impact || ""}
                                        onChange={(e) => handleParamChange(index, paramIndex, "impact", e.target.value)}
                                      />
                                      </div>
                                      <div className="w-[30%] mt-4 "> <TextField
                                      type="number"
                                        ...
                                        onChange={(e) => handleParamChange(index, paramIndex, "multiplier", e.target.value)}
                                      /></div>
