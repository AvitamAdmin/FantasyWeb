  ...
  const handlePostClick = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        router.push("/fantasy/admin/datasource");
      }, 2000);
                    ...
                    <div className=" gap-2 mt-4 flex flex-col rounded-md">
                      {item.dataSourceInputs &&
                        ...
                        item.dataSourceInputs.map((input, inputIndex) => (
                          ...
                          >
                            <div
                              onClick={() => handleToggle(index, inputIndex, "comma")}
                              className={`border-2 border-solid rounded-md text-xs px-2 py-0.5 w-[70px] h-[25px] ${input.comma
                            ...
                            <div
                              onClick={() => handleToggle(index, inputIndex, "importBox")}
                              className={`border-2 border-solid rounded-md text-xs px-2 py-0.5 w-[70px] h-[25px] ${input.importBox
                                ? "bg-[#1581ed] text-center cursor-pointer  text-white border-[#1581ed]"
                                : "bg-white text-gray-700 border-gray-400 text-center cursor-pointer"
                                }`}
                            >
                            ...
                            <div
                              onClick={() => handleToggle(index, inputIndex, "optional")}
                              className={`border-2 border-solid rounded-md text-xs px-2 py-0.5 w-[70px] h-[25px] ${input.optional
                                ? "bg-[#1581ed] text-center cursor-pointer  text-white border-[#1581ed]"
                                : "bg-white text-gray-700 border-gray-400 text-center cursor-pointer"
                                }`}
                            >
                            ...
                            <div
                              onClick={() => handleToggle(index, inputIndex, "fileName")}
                              className={`border-2 border-solid rounded-md text-xs px-2 py-0.5 w-[70px] h-[25px] ${input.fileName
                                ? "bg-[#1581ed] text-center cursor-pointer  text-white border-[#1581ed]"
                                : "bg-white text-gray-700 border-gray-400 text-center cursor-pointer"
                                }`}
                            >
                            ...
                            <div
                              onClick={() => handleToggle(index, inputIndex, "fixed")}
                              className={`border-2 border-solid rounded-md text-xs px-2 py-0.5 w-[70px] h-[25px] ${input.fixed
                                ? "bg-[#1581ed] text-center cursor-pointer  text-white border-[#1581ed]"
                                : "bg-white text-gray-700 border-gray-400 text-center cursor-pointer"
                                }`}
                            >
