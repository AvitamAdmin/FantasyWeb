...
const EditDashBoard = () => {
  ...
  const [selectedDashboardProfileList, setSelectedDashboardProfileList] = useState([]);
          ...
          >
            <div className="bg-white p-4 rounded-md shadow-md">
              ...
              <div className="w-full flex flex-row gap-5">
               <div className="w-[50%]"><DashboardProfile initialLoad={initialload}
               ...
               <SingleSelectSubsidiary initialload={initialload}
