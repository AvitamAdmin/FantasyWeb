...
const AddDashboard = () => {
  ...
  const validateForm = () => {
    ...
    setErrors(newErrors);
    return Object.keys(newErrors).length === 0 && selectedSubsidiary?.length > 0;        
  };
  const handleSaveClick = async () => {
    ...
    try {
     ...
     setTimeout(() => {
      router.push("/fantasy/admin/dashboard");
    }, 2000);
          ...
          <div className="bg-white p-4 rounded-md shadow-md">
            ...
            <div className='flex flex-col gap-3'>
              <div className='grid grid-cols-2 gap-4 mb-4'>
                <DashboardProfile initialload={initialload} selectedDashboardProfile={selectedDashboardProfile} setSelectedDashboardProfile={setSelectedDashboardProfile} />
                <div className='mt-5'>
