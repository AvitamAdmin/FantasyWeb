                    ...
                    <div className="flex flex-row  items-center mt-8 w-[33%] justify-end">
                      {ButtonActive ? (
                        <div
                          ...
                          className=" border-[#1581ed] bg-[#1581ed] text-center cursor-pointer  text-center pt-0.5 border-2 border-solid rounded-md text-white text-xs px-2 py-0.5 w-[80px] animate__animated  animate__pulse"
                        >
                          Active
                        </div>
                      ) : (
