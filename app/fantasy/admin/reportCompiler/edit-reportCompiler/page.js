...
const [creationTime, setcreationTime] = useState();
  ...
  const handlePostClick = async () => {
    try {
      ...
      setTimeout(() => {
        ...
        router.push("/fantasy/admin/reportCompiler");
      }, 2000);
    } catch (err) {
 ...
 setcreationTime(response.data.reportCompilers[0]?.creationTime || "");
      ...
      if (response?.data?.reportCompilers) {
        ...
        const dataRelationValue = response.data.reportCompilers[0]?.dataRelation || "";
        const dataRelationParamValue =
          response.data.reportCompilers[0]?.reportCompilerMappings[0]?.dataSource || "";
                  ...
                  >
                    ...
                    <div className="flex flex-row gap-5 w-full justify-between">
                      ...
                      <div className="w-full mt-5">
                        <MultiSelectNode initialload={initialload}
...
/>
                          ...
                          <div className="flex flex-row gap-5 justify-center items-end">
                            <div
                              ...
                              className={`${param.isPivot ? "bg-[#1581ed] text-center cursor-pointer  text-white" : "bg-[#fff] text-center cursor-pointer text-gray-700"} border-2 border-solid border-${param.isPivot ? "#1581ed" : "gray-400"} rounded-md text-xs px-2 py-0.5 w-[70px] h-[25px]`}
                            >
                              Pivot
                            </div>
                            <div
