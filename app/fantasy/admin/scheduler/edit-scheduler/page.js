...
const [creationTime, setcreationTime] = useState();
 ...
 const validateForm = () => {
  ...
  const handlePostClick = async () => {
    ...
    const hasEmptySubsidiary = editInputfields.some((item) => !item.subsidiary || item.subsidiary.length === 0);
  
    if (hasEmptySubsidiary) {
      toast.error("Please select Subsidiary");
      return; d// Stop the function execution if subsidiary is empty
    }
                            ...
                            <div className=" flex flex-row items-center justify-center gap-7">
                              <div>
                                <div
                                  ...
                                  } border-2 border-blue-500 rounded-md text-xs w-[80px] px-2 py-0.5`}
                                >
                                  {buttonActiveList[index]
                                    ? "Active"
                                    : "Inactive"}
                                ...
                                <div
                                  ...
                                  className={`${
                                    historyActiveList[index]
                                      ? "bg-blue-500 text-white"
                                      : "bg-white text-blue-500"
                                  } border-2 border-blue-500 rounded-md text-xs px-2 py-0.5 w-[100px]`}
                                >
                                  {historyActiveList[index]
                                    ? "Save History"
                                    : "Unsave"}
