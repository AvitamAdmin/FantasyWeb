...
const AddToolkitCronjobs = () => {
  ...
  const handleSaveClick = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push("/fantasy/admin/scheduler");
                  ...
                  <div>
                    {HistoryActive ? (
                      <div
                        ...
                        className="bg-[#1581ed] text-center cursor-pointer  border-2 border-solid border-gray-400 text-center cursor-pointer rounded-md text-white text-xs px-2 py-0.5 w-[100px] animate__animated  animate__pulse"
                      >
                        Save History
                      </div>
                    ) : (
