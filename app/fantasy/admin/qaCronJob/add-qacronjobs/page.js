        ...
        {params.map((param, index) => (
          ...
          >
            ...
            <Autocomplete
              ...
              value={
                subsidiary.find((subs) => subs.recordId === param.subsidiariedata) || null
              }
              onChange={(event, newValue) => {
                handleInputFieldChange(index, "subsidiariedata", newValue?.recordId || "");
              ...
              renderInput={(params) => (
                <TextField {...params} label="Select Subsidiary" variant="standard" />
              )}
            />
            ...
            <Autocomplete
              ...
              getOptionLabel={(option) => option.identifier || ""}
              value={
                param.sitesList.find((site) => site.recordId === param.sitesdata) || null
              }
              onChange={(event, newValue) => {
                handleInputFieldChange(index, "sitesdata", newValue?.recordId || "");
              }}
              isOptionEqualToValue={(option, value) =>
                option.recordId === value?.recordId
              }
              renderInput={(params) => (
                <TextField {...params} label="Select Sites" variant="standard" />
              )}
            />
            ...
            <Autocomplete
              ...
              getOptionLabel={(option) => option.identifier || ""}
              value={
                param.testProfile.find((profile) => profile.recordId === param.testprofiledata) || null
              }
              onChange={(event, newValue) => {
                handleInputFieldChange(index, "testprofiledata", newValue?.recordId || "");
              }}
              isOptionEqualToValue={(option, value) =>
                option.recordId === value?.recordId
              }
            ...
            <Autocomplete
              ...
              getOptionLabel={(option) => option.identifier || ""}
              value={
                param.environments.find((env) => env.recordId === param.environmentdata) || null
              }
              onChange={(event, newValue) => {
                handleInputFieldChange(index, "environmentdata", newValue?.recordId || "");
              }}
              isOptionEqualToValue={(option, value) =>
                option.recordId === value?.recordId
              }
            ...
            <Autocomplete
              ...
              getOptionLabel={(option) => option.identifier || ""}
              value={
                param.testPlanList.find((plan) => plan.recordId === param.testplandata) || null
              }
              onChange={(event, newValue) => {
                handleInputFieldChange(index, "testplandata", newValue?.recordId || "");
              }}
              isOptionEqualToValue={(option, value) =>
                option.recordId === value?.recordId
              }
            ...
            <Autocomplete
              ...
              getOptionLabel={(option) => option.identifier || ""}
              value={
                param.categoryList.find((category) => category.recordId === param.categorydata) || null
              }
              onChange={(event, newValue) => {
                handleInputFieldChange(index, "categorydata", newValue?.recordId || "");
              }}
              isOptionEqualToValue={(option, value) =>
                option.recordId === value?.recordId
              }
            ...
            <Autocomplete
  options={param.cronjobProfile || []}  // Ensures cronjobProfile is an array
  getOptionLabel={(option) => option.identifier || ""}
  value={
    (param.cronjobProfile || []).find(
      (cronjob) => cronjob.recordId === param.cronjobprofiledata
    ) || null
  }
  onChange={(event, newValue) => {
    handleInputFieldChange(index, "cronjobprofiledata", newValue?.recordId || "");
  }}
  isOptionEqualToValue={(option, value) =>
    option.recordId === value?.recordId
  }
