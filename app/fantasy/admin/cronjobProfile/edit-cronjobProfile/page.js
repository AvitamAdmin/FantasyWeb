...
const [creationTime, setcreationTime] = useState();
  ...
  const handlePostClick = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push("/fantasy/admin/cronjobProfile");
        ...
        <div className="bg-gray-200 flex flex-col pb-5 rounded-md" key={index}>
          ...
          <div className="w-[100%] flex items-center flex-row justify-center">
            ...
            <div
              ...
              className={`${
                item.ButtonActive ? "bg-[#1581ed] text-center cursor-pointer  text-white border-[#1581ed]"  : "bg-[#fff] text-gray-500 border-gray-400 text-center cursor-pointer"
