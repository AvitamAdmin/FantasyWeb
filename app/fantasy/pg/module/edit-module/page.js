...
const editmodule = () => {
    ...
    const handleFetchData = async (jwtToken) => {
        try {
            ...
            setLoading(false)
            console.log(response.data.modules, "response from API");
            setEditInputfields(response.data.modules);
        } catch (err) {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const body = {
                modules: editInputfields.map((item) => ({
            ...
            router.push("/fantasy/pg/module");
        } catch (err) {
            console.error(err, "Error occurred while saving");
            setError("Error saving module data");
        } finally {
            setLoading(false);
        }
    };
