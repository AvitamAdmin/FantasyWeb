...
const Editcatalog = () => {
    ...
    const handleFetchData = async (jwtToken) => {
        try {
            ...
            setLoading(false)
            console.log(response.data.catalogs, "response from API");
            setEditInputfields(response.data.catalogs);
        } catch (err) {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const body = {
                catalogs: editInputfields.map((item) => ({
            ...
            router.push("/fantasy/pg/catalog");
        } catch (err) {
            setError("Error fetching catalog data");
        } finally {
            setLoading(false);
